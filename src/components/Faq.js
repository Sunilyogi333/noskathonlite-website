...
const Faq = ({question, answer}) => {
  ...
  return (
<div className="relative max-w-md mx-auto md:max-w-3xl py-0">
  <div className="bg-nosk-white transition-shadow drop-shadow-2xl hover:border-2 border-nosk-green hover:shadow-lg">
    ...
    <div className="flex justify-between items-center p-6 relative">
      <h2 className="text-xl font-semibold text-nosk-black text-left ml-6 md:text-xl md:mr-32">{question}</h2>
    ...
    <div
      className={`overflow-hidden transition-all duration-700 ease-in-out ${isExpanded ? 'max-h-screen' : 'max-h-0'}`} 
