...
export default function TeamSection() {
  ...
  return (
    <div className="py-10 px-4">
      {/* Coordinator */}
      <div className="mt-4 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {teamlead.map((member, index) => (
          <div
            key={index}
            className="bg-nosk-yellow-trans rounded-lg shadow-lg p-4 sm:p-6 flex flex-col items-center border-4 border-transparent transition-all duration-300 ease-in-out hover:bg-nosk-yellow hover:shadow-xl hover:border-nosk-green group"
          >
            <div className="flex flex-row items-center space-x-4">
              <div className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full border-4 border-nosk-white overflow-hidden">
                <Image
                  src={member.image}
                  alt={member.name}
                  fill
      ...
      <div className="mt-8 max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {teamMembers.map((member, index) => (
          <div
            key={index}
            className="bg-nosk-yellow-trans rounded-lg shadow-lg p-6 flex flex-col items-center border-4 border-transparent transition-all duration-300 ease-in-out hover:shadow-xl hover:bg-nosk-yellow hover:border-nosk-green group"
          >
