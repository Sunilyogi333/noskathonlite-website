      ...
      <div className="relative rounded-lg p-8 mx-auto flex justify-center items-center">
        <div className="relative flex flex-col items-center">
          ...
          <div className="flex flex-col justify-center items-center min-h-[5rem] pl-24">
            ...
            <p className="text-nosk-green font-semibold text-xl tracking-wider">NPR 30,000</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div className="relative rounded-lg p-8 mx-auto flex justify-center items-center">
          <div className="relative flex flex-col items-center">
            ...
            <div className="flex flex-col justify-center items-center min-h-[4rem] pl-24">
              <h2 className="text-nosk-green font-bold text-3xl mb-3 whitespace-nowrap">1st Runner Up</h2>
              <p className="text-nosk-green font-semibold text-xl tracking-wider">NPR 20,000</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative rounded-lg p-8 mx-auto flex justify-center items-center">
          <div className="relative flex flex-col items-center">
            ...
            />
            <div className="flex flex-col justify-center items-center min-h-[4rem] pl-24">
              <h2 className="text-nosk-green font-bold text-3xl mb-3 whitespace-nowrap">2nd Runner Up</h2>
              <p className="text-nosk-green font-semibold text-xl tracking-wider">NPR 10,000</p>
            </div>
          </div>
        </div>
      </div>
