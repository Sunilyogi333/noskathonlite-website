...
const CountDown = () => {
    ...
    return (
<div className="relative flex flex-col items-center p-1 bg-nosk-green text-nosk-white w-full">
    <p className="text-base md:text-lg font-semibold">LIVE IN:</p>
    ...
    <div className="flex flex-wrap space-x-2 md:space-x-3 text-2xl md:text-3xl md:pt-3 md:pb-2">
        <div className="text-center">
            <p className="font-bold text-3xl m-0 leading-none">{timeLeft.days}</p>
            <p className="text-[0.5rem] opacity-50 m-1 leading-none">DAYS</p>
        </div>
        <div className="text-center">
            <p className="font-bold text-3xl m-0 leading-none">{timeLeft.hours}</p>
            <p className="text-[0.5rem] opacity-50 m-1 leading-none">HOURS</p>
        </div>
        <div className="text-center">
            <p className="font-bold text-3xl m-0 leading-none">{timeLeft.minutes}</p>
            <p className="text-[0.5rem] opacity-50 m-1 leading-none">MINUTES</p>
        </div>
        <div className="text-center">
            <p className="font-bold text-3xl m-0 leading-none">{timeLeft.seconds}</p>
